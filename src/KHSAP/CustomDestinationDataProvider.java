...
public class CustomDestinationDataProvider
{
    ...
    static Properties getDestinationPropertiesFromUI()
    {
        ...
        connectProperties.setProperty(DestinationDataProvider.JCO_ASHOST,"192.168.90.104");
	    connectProperties.setProperty(DestinationDataProvider.JCO_SYSNR, "00");
	    connectProperties.setProperty(DestinationDataProvider.JCO_CLIENT, "800");
	    connectProperties.setProperty(DestinationDataProvider.JCO_USER,"khplmcs");
	      // 注：密码是区分大小写的，要注意大小写
	    connectProperties.setProperty(DestinationDataProvider.JCO_PASSWD,"112233");
    ...
    public static void main(String[] args)
    {
        ...
        //String destName = "ABAP_AS_WITHOUT_POOL";
